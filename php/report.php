...
<table id="table"
  ...
  <thead>
    <tr>
      ...
      <!--data-sortable="true"  <th data-field="sn_hw_order">С/Н</th> -->
      <th data-field="name_hw_order">Наименование</th>
      <th data-sortable="true" data-field="order_datetime">Дата заявки</th>
      <!--data-sortable="true"  <th data-field="order_end_datetime">Заявка выполнена</th> -->
      <!--data-sortable="true"  <th data-field="warranty_order">Гарантия</th> -->
