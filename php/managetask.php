...
<script>
  ...
  function operateFormatter(value, row, index) {
    return [
      ...
      '<a class="takeord" href="javascript:void(0)" title="Закрепить заказ">',
      '<i class="fas fa-arrow-circle-right"></i>',
      '</a>  ',
      '<a class="doneord text-success" href="javascript:void(0)" title="Завершить заказ">',
      '<i class="fas fa-check-circle"></i>',
      '</a>  ',
      '<a class="closeord text-danger" href="javascript:void(0)" title="Закрыть заказ">',
