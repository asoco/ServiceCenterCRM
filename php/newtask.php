...
var productIds = new Object();
        var devices = <?php echo(json_encode($json)); ?>;
        console.log(devices);     
        $.each( devices, function ( index, product )
            {
                productNames.push( product.name_prod_list );
                productIds[product.name] = product.id_prodlist;
            } );   

        
         var devices_suggestion = new Bloodhound({
